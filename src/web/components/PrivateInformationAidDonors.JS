...
function privateInformationAidDonors() {
  const [name, setName] = useState("");
  const [nationalityDonors, setNationalityDonors] = useState("");
  ...
  const handleSubmit = (e) => {
    ...
    const doc = {
      ...
      nationalityDocExp3,
      file,
      typeOfForm: "privateInformationAidDonors",
    };
    console.log(doc);
  ...
  return (
    <div class="row text-center">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <label htmlFor="name">Nationality of Donors:</label>
        <br />
        <input
          type="text"
          id="nationalityDonors"
          name="nationalityDonors"
          value={nationalityDonors}
          onChange={(e) => setNationalityDonors(e.target.value)}
        />
        <br />
...
export default privateInformationAidDonors;
